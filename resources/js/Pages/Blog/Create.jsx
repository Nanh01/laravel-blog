                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        ...
                        <form method="POST" onSubmit={(e) => handleSubmit(e)}>
                            <div>
                            <InputText id="title" name="title" label="Title" value={data.title} placeholder="Title" setData={setData}></InputText>
                            <InputText id="content" name="content" label="Content" value={data.content} placeholder="Content" setData={setData}></InputText>
